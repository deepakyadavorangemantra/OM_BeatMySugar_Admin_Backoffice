(function (j) {
	...
	}) : "object" === typeof exports ? module.exports = function (f, k, v, r) {
		f || (f = window);
			...
			if (j.isPlainObject(c)) {
				...
				if (s) {
					...
					for (g = e.attributes.length - 1; 0 <= g; g--) {
						...
						var f = e.attributes[g].nodeValue; - 1 !== w.indexOf(":") && (i.push({
							name: w,
							value: f
						}), e.removeAttribute(w))
					}
	...
	if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) u = void 0;
		...
		var y = h.document.createElementNS("https://www.w3.org/1999/xhtml", "a"),
			M = "download" in y,
		...
		} : (l.abort = function () {}, l.readyState = l.INIT = 0, l.WRITING = 1, l.DONE = 2, l.error = l.onwritestart = l.onprogress = l.onwrite = l.onabort = l.onerror = l.onwriteend = null, u = function (a, b, d) {
	...
	var G = function (a) {
		...
		I = function (a, b) {
			for (var d = H(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, g = b.fieldSeparator, j = RegExp(e, "g"), i = b.escapeChar !== o ? b.escapeChar : "\\", f = function (a) {
					for (var c = "", b = 0, d = a.length; b < d; b++) 0 < b && (c += g), c += e ? e + ("" + a[b]).replace(j, i + e) + e : a[b];
					return c
				}, h = b.header ? f(c.header) + d : "", k = b.footer && c.footer ? d + f(c.footer) : "", n = [], m = 0, l = c.body.length; m < l; m++) n.push(f(c.body[m]));
			return {
				str: h +
					n.join(d) + k,
				rows: n.length
	...
	var B = {
			"_rels/.rels": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="https://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>',
	...
	q.ext.buttons.excelHtml5 = {
		...
		action: function (a, b, d, c) {
			...
			p = 0;
			for (s = k.header.length; p < s; p++) m.appendChild(n(i, "col", {
				attr: {
					min: p + 1,
					max: p + 1,
					width: L(k, p),
	...
	q.ext.buttons.pdfHtml5 = {
		...
		action: function (a, b, d, c) {
			...
			for (var g = 0, h = d.body.length; g < h; g++) e.push(j.map(d.body[g], function (a) {
				if (null === a || a === o) a = "";
				return {
					text: "string" === typeof a ? a : a + "",
