                   ...
                   if(this.props.sockscredential.HSNCode!=''){
                    if(this.state.AddAccess){
                      ...
                      if(results.status == 200 || results.status==201){
                       ...
                       Notiflix.Notify.Success('Socks item successfully added.')
                       ...
                       Notiflix.Loading.Remove()
                       Notiflix.Notify.Failure('Socks item already registered.')
                     } 
                   }
                      )
                    )
                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" class="float-right mt-1">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Add New Socks</li>
                                            </ol>
                                        </nav>
                                        <h4 class="mb-1 mt-0">Add New Socks Item</h4>
                                    </div>
                                </div>
