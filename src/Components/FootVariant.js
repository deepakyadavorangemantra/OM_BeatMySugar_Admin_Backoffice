            ...
            <div class="content">
              <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb" class="float-right mt-1">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Footwear Variants List
                        </li>
                    </ol>
                </nav>
                <h4 class="mb-1 mt-0">Footwear Variants List
                    </h4>
                </div>
                    </div> 
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col ">
                            <a href='/footwearitemmasterlist'>
                            <button 
                            
                            class="btn btn-primary" id="btn-new-event"><i
                                    class="uil-arrow-left mr-1"></i>Back To Footwear List</button>
                       
                            </a>
                                                            </div>
                            
                           <div class="col text-right" style={{display : this.state.AddAccess ? '' : 'none'}}>
                                   <a href='/addnewfootwearvariant'>
                                   <button 
                                   
                                   class="btn btn-primary" id="btn-new-event"><i
                                   class="uil-plus mr-1"></i>Add New Footwear Variant</button>
                ...
                <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                <h5 class="mb-1 mt-0">Footwear Master Details
                    </h5>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                <h5 class="mb-1 mt-0">Footwear Variant List
                    </h5>
                                <div class="table-responsive">
                                ...
                                <td>{data.fld_sku}</td>
                                    ...
                                    onClick={()=>{
                                        ...
                                        localStorage.setItem('FootwearVariantDetails',JSON.stringify(data))
                                        window.location.href = '/viewfootwearvariant'
                                    }}
                                    >
                                <span  >
                                <Edit3/>
