                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" className="float-right mt-1">
                                            <ol className="breadcrumb">
                                                ...
                                                <li className="breadcrumb-item"><a href="/fooditemmasterlist">Food List</a></li>
                                                <li className="breadcrumb-item"><a href="/foodvariantlist">Food Variant List</a></li>
                                                <li className="breadcrumb-item active" aria-current="page">Add New Food Variant</li>
                                            </ol>
                                        </nav>
                                        <h4 className="mb-1 mt-0">Add New Food Variant</h4>
                                    </div>
                                </div>
                                            ...
                                            <div className="card-body">
                                                <div id="smartwizard-arrows">
                                                    <ul>
                                                        ...
                                                        }} className="wizardlist nav-link">Food Item Variants                                                        </a></li>
                                                    ...
                                                    <div className="p-3" style={{ minHeight: '0px' }}>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="toast-header">
                                                                <strong className="mr-auto">Food Item Variants</strong>
                                                            </div>
                                                ...
                                                aria-atomic="true" data-toggle="toast">
                                                <div className="toast-header">
                                                <strong className="mr-auto">Net Content Weight</strong>
                                            </div>
                                                <div className="toast-body">
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                                ...
                                                                <div className="toast-body">
                                                                    <div className="row">
                                                                        ...
                                                                        <div className="form-group mb-3">
                                                                         ...
                                                                         <textarea className="form-control" rows="3" cols="15"
