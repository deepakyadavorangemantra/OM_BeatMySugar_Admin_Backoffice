...
class ViewFootwearVariant extends Component {
    ...
    componentDidMount() {
        ...
        var det = localStorage.getItem('FootParentIdDetails')
        ...
        this.props.setcolor(VariantData.fld_colorid)
        this.props.setfootwearprice(VariantData.fld_price)
        this.props.setfootweardiscount(VariantData.fld_discountpercent)
        this.props.setfootweardiscountprice(VariantData.fld_discountprice)
        this.props.setfootweartitle(VariantData.fld_titlebar)
        this.props.setfootwearkey(VariantData.fld_keywords)
        this.props.setfootwearmeta(VariantData.fld_metadescription)
        this.props.setfootwearpacklength(VariantData.fld_length)
        this.props.setfootwearpackbreadth(VariantData.fld_breadth)
        this.props.setfootwearpackheight(VariantData.fld_heigth)
        this.props.setfootwearpackunit(VariantData.fld_volumnetricunit)
        this.props.setfootwearpackweightunit(VariantData.fld_packageunit)
        this.props.setfootwearpackagingweight(VariantData.fld_packageweight)
        ...
        PostApiCall.postRequest({
           ...
           var filteredRights = objsub.data;
                ...
                for(var i = 0 ; i< filteredRights.length ;i++){
                    ...
                    if(filteredRights[i].fld_menuname == 'Edit Footwear'){
                    ...
                    }else if(filteredRights[i].fld_menuname == 'Approve Footwear'){
     ...
     nextlabel(){
             if(this.props.footcredential.VarientName!=''){
                if(this.props.footcredential.VarientName.length < 160){
                     ...
                     Notiflix.Notify.Failure('Please enter footwear variant name with less then 160 characters.')
                    }
                         }
                         else{
    ...
    onChangeVolume(volumetricweight){
     ...
     onChangePrice(price){
        if((this.state.DecimalRegex.test(price.target.value))){
            ...
            this.props.setfootweardiscountprice(parseFloat(price.target.value-(this.props.footcredential.DiscountPer*price.target.value)/100).toFixed(2))
     ...
     onChangeDisc(discount){
        if((this.state.DecimalRegex.test(discount.target.value))){
            ...
            this.props.setfootweardiscountprice(parseFloat(this.props.footcredential.Price-(discount.target.value*this.props.footcredential.Price)/100).toFixed(2))
  ...
  if(this.state.ImageCoverData != ''){
    ...
    form.append('foldername' , 'Footwear')
     ...
     ApproveFootwear(){
        if(this.state.ApproveAccessGranted){
            ...
            confirmAlert({
                ...
                message: 'Are you sure you want to approve footwear variant.',
                buttons: [
                  {
                    label: 'Yes',
                    onClick: () => {
            ...
            PostApiCall.postRequest({
                ...
                if(results.status == 200 || results.status==201){
                    ...
                    Notiflix.Notify.Success('Footwear variant successfully approved.')
                    window.location.href = '/footwearvariantlist'
                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" class="float-right mt-1">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="/footwearitemmasterlist">Footwear List</a></li>
                                                <li class="breadcrumb-item"><a href="/footwearvariantlist">Footwear Variant List</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">View Footwear Variant</li>
                                                </ol>
                                        </nav>
                                        <h4 class="mb-1 mt-0">View Footwear Variant</h4>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center col-lg-6" style={{float : 'right'}}>
                                      ...
                                      onClick={this.ApproveFootwear.bind(this)}
                                        class="btn btn-primary" id="btn-new-event" data-toggle="modal"><i
                                                class="uil-check mr-1"></i>Approve Footwear Variant</button>
                                                </div>
                                            ...
                                            <div className="card-body">
                                                <div id="smartwizard-arrows">
                                                    <ul>
                                                        ...
                                                        }} class="wizardlist nav-link">Footwear Item Variants</a></li>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="toast fade show" role="alert" aria-live="assertive"
                                                                ...
                                                                <div class="toast-header">
                                                                    <strong class="mr-auto">footwear Item Variants</strong>
                                                                </div>
