...
class SocksGrid extends Component {
     constructor(props){
         super(props)
         this.state={
            SocksData:[],
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Socks List
                                    </li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">Socks List
                            </h4>
                        </div>
                    </div> 
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-6 text-right" style={{display : this.state.AddAccess ? '' : 'none'}}>
                                       <a href='/addsocksitemmaster'>
                                       <button 
                                       
                                       class="btn btn-primary" id="btn-new-event" data-toggle="modal"><i
                                               class="uil-plus mr-1"></i>Add New Socks Item</button>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <tr><td colSpan={7} style={{textAlign:'center'}}>No Socks Item Master Available</td></tr> : 
                                ''} 
                          ...
                          <td>{data.fld_code}</td>
                               <td>{data.fld_name} 
                                ...
                                onClick={()=>{
                                  ...
                                  localStorage.setItem('SocksParentIdDetails',JSON.stringify(data))
                          ...
                          >{data.VariantCount} Variant{data.VariantCount == 1 ? '' : 's'} Available ( <span style={{color:'red'}}>{data.NotApproved} Pending</span>, <span style={{color:'green'}}>{data.Approved} Approved</span> )</a>
                              ...
                              onClick={()=>{
                                ...
                                localStorage.setItem('SocksDetails',JSON.stringify(data))
                                window.location.href = '/viewsocks'
                              }}
                              >
                          <span  >
                          <Edit3/>
