...
cellpadding="0">
  ...
  <div class="card">
      ...
      <td>&#8377;{parseFloat(((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))+((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))*(data.fld_taxpercent/100)))-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100))))) : (data.fld_mrp-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100))))).toFixed(2)}</td>
  ...
  <div class="card">
      ...
      {this.state.VendorOrders.map((ord, index)=>(
          ...
          <tr key={index} >
                   ...
                   <td>{ ord.VenDet != undefined && ord.VenDet.length > 0  ?  parseFloat(((ord.VenDet.map(data => (((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100))))) : (data.fld_mrp-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))))).reduce((prev, next) => parseFloat(prev) + parseFloat(next))))).toFixed(2) : 0}</td>
                   <td>{ord.VenDet != undefined && ord.VenDet.length > 0  ?  parseFloat(ord.VenDet.map(data => (((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))+((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))*(data.fld_taxpercent/100)))-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100))))) : (data.fld_mrp-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))))).reduce((prev, next) => parseFloat(prev) + parseFloat(next)) + parseFloat(ord.fld_shippingcharges)).toFixed(2) : 0}</td>
      ...
      Notiflix.Loading.Dots()
        ...
        for(var i=0; i<this.state.VendorOrders.length;i++){
            ...
            merchantdet.push(
                ...
                "aggregatorCharges":parseFloat(ord.VenDet.map(data => (((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))+((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))*(data.fld_taxpercent/100)))-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100))))) : (data.fld_mrp-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))))).reduce((prev, next) => parseFloat(prev) + parseFloat(next)) + parseFloat(ord.fld_shippingcharges)).toFixed(2)
                ,"aggregatorDiscount":"0","sellerDiscount":"0","CODAmount":"0",
                "splitDetails":"Payment-Split" ,
                "amountToBeSettled":parseFloat(((ord.VenDet.map(data => (((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100))))) : (data.fld_mrp-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_mrp*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))))).reduce((prev, next) => parseFloat(prev) + parseFloat(next))))).toFixed(2)
            }
            )
