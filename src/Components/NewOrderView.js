...
var grp =grouped[i]
  ...
  PostApiCall.postRequest({
    ...
    offercode : this.state.MainOrder.fld_offercode
    ...
    for(var s = 0 ;s<grouped.length ;s++){
      ...
      for(var j =0 ;j<grouped[s].length;j++){
        ...
        PostApiCall.postRequest({
            ...
            mrp : grouped[s][j].fld_mrp,
            vendorsellingprice : grouped[s][j].fld_vendorsellingprice
                        ...
                        <div className="col-md-12">
                            <nav aria-label="breadcrumb" className="float-right mt-1">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">View Order
                                    </li>
                                </ol>
                            </nav>
                            <h4 className="mb-1 mt-0">View Order
                            </h4>
                        </div>
                    </div> 
...
cellpadding="0">
    <tbody>
        ...
        <td  colspan="4"></td>
          ...
          >
            ...
            <button className="btn btn-primary" type="submit" style={{float:'right',margin: '20px'}}
    ...
    <div className="modal-content modelcontent2">
      <div className="modal-header">
        <h4 className="modal-title">Assign Order to Vendor</h4>
      </div>
      ...
      <div className="col-md-12">
        ...
        <div className="col-md-12" style={{display : this.state.IsAlreadyShipAssigned > 0 ? 'none' : ''}}>
            <div className="form-group mb-3">
