...
import AddBanner from './AdBannerManagement';


import AccessoriesCategory from './AccessoriesCategoryMaster'
import AccessoriesSizeMaster from './AccessoriesSizeMaster';
import AccessoriesColorMaster from './AccessoriesColorMaster';
import AccessoriesTypeMaster from './AccessoriesTypeMaster';


import AccessoriesGrid from './AccessoriesGrid';
import Accessories from './Accessories';
import AccessoriesVariantGrid from './AccessoriesVariantGrid';
import AddAccessoriesVarient from './AddAccessoriesVarient';
import ViewAccessoriesItemMaster from './ViewAccessories';
import ViewAccessoriesVariant from './ViewAccessoriesVariant';

import CovidColorMaster from './CovidColorMaster';
import CovidCategory from './CovidCategoryMaster';
import CovidFilter from './CovidFilterMaster';
import CovidSizeMaster from './CovidSizeMaster';
import ViewCovidEssentialsItem from './ViewCovidEssentialItemMaster'
import ViewCovidVariant from './ViewCovidVariant'
import covidEssentialGrid from './CovidEssentialGrid';
                ...
                <div id="sidebar-menu" className="slimscroll-menu">
                    ...
                    {this.state.Menu.map((menu,index)=>(
                              ...
                              {this.state.SubMenu[index] == undefined ? <span></span>  : this.state.SubMenu[index].length > 0 || menu.fld_menuname == 'Master Management' || menu.fld_menuname == 'Reports' ? <span className="menu-arrow"></span> : <span></span>}  
                               ...
                               <li> <a href='/accessoriescategory'>Accessories Category</a></li>
                                    <li> <a href='/accessoriescolor'>Accessories Color</a></li>
                                    <li> <a href='/accessoriessize'>Accessories Size</a></li>
                                    <li> <a href='/accessoriestype'>Accessories Type</a></li>
                                    ...
                                    <li> <a href='/bookscategorymaster'> Books Categories</a></li>
                                       ...
                                       <li> <a href='/covidcategory'>Covid Category</a></li>
                                    <li> <a href='/covidcolor'>Covid Color</a></li>
                                    <li> <a href='/covidsize'>Covid Size</a></li>
                                    <li> <a href='/covidfilter'>Covid Filter</a></li>
...
{/* <li>
       ...
       <Route exact path='/viewinsurance' component={ViewInsurance}></Route>
        ...
        <Route exact path='/editbanner' component={EditBanner}></Route>
        <Route exact path='/addbanner' component={AddBanner}></Route>
        <Route exact path='/bannermanagement' component={BannerManagement}></Route>


        <Route exact path='/accessoriescategory' component={AccessoriesCategory}></Route>
        <Route exact path='/accessoriessize' component={AccessoriesSizeMaster}></Route>
        <Route exact path='/accessoriescolor' component={AccessoriesColorMaster}></Route>
        <Route exact path='/accessoriestype' component={AccessoriesTypeMaster}></Route>

        <Route exact path='/accessoriesitemmasterlist' component={AccessoriesGrid}></Route>
        <Route exact path='/addaccessoriesitemmaster' component={Accessories}></Route>
        <Route exact path='/accessoriesvariantlist' component={AccessoriesVariantGrid}></Route>
        <Route exact path='/addaccessoriesvariant' component={AddAccessoriesVarient}></Route>
        <Route exact path='/accessoriestype' component={AccessoriesTypeMaster}></Route>
        <Route exact path='/viewaccessoriesitemmaster' component={ViewAccessoriesItemMaster}></Route>
        <Route exact path='/viewaccessoriesvariant' component={ViewAccessoriesVariant}></Route>


        <Route exact path='/covidcolor' component={CovidColorMaster}></Route>
        <Route exact path='/covidcategory' component={CovidCategory}></Route>
        <Route exact path='/covidfilter' component={CovidFilter}></Route>
        <Route exact path='/covidsize' component={CovidSizeMaster}></Route>
        <Route exact path='/covidessentialsmasterlist' component={covidEssentialGrid}></Route>
        <Route exact path='/addcovidandhealthessential' component={AddCovidEssential}></Route>
        <Route exact path='/covidvariantlist' component={CovidVarient}></Route>
