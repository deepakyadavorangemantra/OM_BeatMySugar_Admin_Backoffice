...
class Doctors extends Component {
        ...
        PostApiCall.postRequest({
           ...
           var filteredRights = objsub.data;
                ...
                for(var i = 0 ; i< filteredRights.length ;i++){
                    ...
                    if(filteredRights[i].fld_menuname == 'Add Doctors'){
    ...
    OnCertificatePdfSubmit(data,obj){
        ...
        {    
                                ...
                                form.append('filename' , this.state.CertificateData[i].Certificate.trim().replace(/\s/g,'-').replace(/\//g,'-')+'-'+data[i]+'-'+(JSON.parse(JSON.stringify(obj.data[0]))).DoctorId)
    ...
    OnQualificationSubmit(obj){
        ...
        var login=localStorage.getItem('LoginDetail');
                    ...
                    for(var i = 0 ;i < this.state.QualificationInfo.length;i++)
                     {                        
                        PostApiCall.postRequest({
                            doctorid : (JSON.parse(JSON.stringify(obj.data[0]))).DoctorId,
        ...
        if(this.state.CertificateData.length> 0)
{
    ...
    OnConsentSubmit(obj){
        ...
        form.append('filename' , 'Consent-'+(JSON.parse(JSON.stringify(obj.data[0]))).DoctorId)
        ...
        status: image.status
            ...
            PostApiCall.postRequest({
                ...
                id : (JSON.parse(JSON.stringify(obj.data[0]))).DoctorId,
    ...
    OnPhotosubmit(obj){
        ...
        form.append('filename' , 'Photo-'+(JSON.parse(JSON.stringify(obj.data[0]))).DoctorId)
        ...
        status: image.status
            ...
            PostApiCall.postRequest({
             ...
             if(results1.status == 200 || results1.status==201){
                ...
                this.props.setcleardoctor()
                Notiflix.Loading.Remove()
                Notiflix.Notify.Success('Doctor successfully added.')
                            ...
                            <div className="container-fluid">
                                <div className="row page-title">
                                    <div className="col-md-12">
                                        ...
                                        <h4 class="mb-1 mt-0">Add New Doctor</h4>
                                    </div>
                                </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                               ...
                                                                               onChange = {this.handleStartDateOfPracticeChange}
                                                                                    ...
                                                                                    onChange = {this.handleStartDateOfDiabetesPracticeChange.bind(this)}
                                                                                    ></input>
                                                                                </div>
                                                                                    </div>
                                                                               </div>
                                                            ...
                                                            <div className="toast fade show" role="alert" aria-live="assertive"
                                                                ...
                                                                <div className='row'>
                                                                    ...
                                                                    <div className="col-md-12">
                                                                       ...
                                                                       onClick={this.handleExperienceChange.bind(this)} >Next</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div id="sw-arrows-step-3"
                                                            ...
                                                            <div className="toast fade show" role="alert" aria-live="assertive"
                                                                ...
                                                                <div class="toast-body">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                            <div class="form-group mb-3">
                                                                                <label for="validationCustom01">Upload Medical Certificate (Size &lt; 2 Mb)<span className="mandatory">*</span></label>
                                                                                  ...
                                                                                  onChange={(e)=>{
                                                                                    if (e.target.files[0].size < 2000000) {
                                                                                        ...
                                                                                        Notiflix.Notify.Failure("File too large, upload file less than 2 Mb.");
                                                                                      } 
                                                                                  }}
                                                                                  />
                                                                            </div>
                                              ...
                                              ></Trash2>
                                                ...
                                                <div className="toast fade show" role="alert" aria-live="assertive"
                                                    ...
                                                    <div class="toast-body">
                                                        ...
                                                        <div class="col-md-8">
                                                        <div class="form-group mb-3">
                                                            <label for="validationCustom01">Consent Form (Size &lt; 2 Mb)<span className="mandatory">*</span></label><br/>
                                                            <input 
