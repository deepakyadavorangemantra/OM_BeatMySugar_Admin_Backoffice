...
class covidEssentialGrid extends Component {
     constructor(props){
         super(props)
        ...
        componentDidMount(){
            Notiflix.Loading.Init({
              ...
              GetApiCall.getRequest("GetCovidItemMaster").then(resultdes =>
              ...
              <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb" class="float-right mt-1">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">COVID & Health Essentials List
                            </li>
                        </ol>
                    </nav>
                    <h4 class="mb-1 mt-0">COVID & Health Essentials List
                    </h4>
                </div>
                    </div> 
                                 ...
                                 <label for="validationCustom01">Filter By:</label>
                                  ...
                                  <select type="text" class="form-control"  required >
                                   ...
                                   <div class="col-md-6 text-right">
                                       <a href='/addcovidandhealthessential'>
                                       <button 
                                       
                                       class="btn btn-primary" id="btn-new-event"><i
                                               class="uil-plus mr-1"></i>Add New COVID & Health Essentials item</button>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <thead>
                                    ...
                                    <tr><td colSpan={7} style={{textAlign:'center'}}>No Covid Item Master Available</td></tr> : 
                                    ''} 
                                    {this.state.CovidData.map((data,index)=>(
                                    ...
                                    <td>{data.fld_code}</td>
                                         <td>{data.fld_name} 
                                          ...
                                          onClick={()=>{
                                            ...
                                            localStorage.setItem('CovidParentIdDetails',JSON.stringify(data))
                                    ...
                                    >{data.VariantCount} Variant{data.VariantCount == 1 ? '' : 's'} Available ( <span style={{color:'red'}}>{data.NotApproved} Pending</span>, <span style={{color:'green'}}>{data.Approved} Approved</span> )</a>
                                        ...
                                        onClick={()=>{
                                            ...
                                            localStorage.setItem('CovidItemMasterDetails',JSON.stringify(data))
                                            window.location.href = '/viewcovidessentialstitemmaster'
                                        }}
                                        >
                                    <span  >
                                    <Edit3/>
...
export default covidEssentialGrid;