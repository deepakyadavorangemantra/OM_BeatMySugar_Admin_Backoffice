...
class ViewAccessoriesVariant extends Component {
    ...
    componentDidMount() {
        ...
        var vardt = localStorage.getItem('AccessoriesVariantDetails')
          ...
          }else
          {
            ...
            if(this.state.Photos[i].remove == 'Yes'){
                ...
                PostApiCall.postRequest({
                 ...
                 },"DeleteAccessoriesVariantImage").then((results2) => 
...
//   for(var j =0 ; j<this.state.VendorPricing.length;j++){
    ...
    //   if(count1 == this.state.VendorPricing.length){
        ...
        Notiflix.Loading.Remove()
        this.props.setclearfootwearitem()
        Notiflix.Notify.Success('Accessories variant updated successfully.')
        ...
        if(this.state.Status!=''){
            ...
            Notiflix.Loading.Dots('');
                ...
                PostApiCall.postRequest({
                     ...
                     updatedby : details[0].fld_staffid,
                     updatedon : moment().format('lll'),
                          },"UpdateAccessoriesItemVariant").then((results) => 
    ...
    //             message: 'Are you sure you want to approve acccessories variant.',
    //             buttons: [
    //               {
    //                 label: 'Yes',
    //                 onClick: () => {
    ...
    ApproveFootwear(){
        if(this.state.ApproveAccessGranted){
            ...
            confirmAlert({
                title: 'Confirm to Approve',
                message: 'Are you sure you want to approve accessories variant.',
                buttons: [
                  {
                    label: 'Yes',
                    onClick: () => {
            ...
            PostApiCall.postRequest({
              ...
              },"UpdateAccessoriesVariantApprovalStatus").then((results) => 
                ...
                if(results.status == 200 || results.status==201){
                    ...
                    Notiflix.Notify.Success('Accessories variant successfully approved.')
                    window.location.href = '/accessoriesvariantlist'
    ...
    render() {
        return (
                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" class="float-right mt-1">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">View Accessories Variant</li>
                                                </ol>
                                        </nav>
                                        <h4 class="mb-1 mt-0">View Accessories Variant</h4>
                                    </div>
                                </div>
          ...
          class="uil-check mr-1"></i>Approve Accessories Variant</button>
                                                 </div>
                                      ...
                                      onClick={()=>{
                                        ...
                                        class="btn btn-primary" id="btn-new-event" data-toggle="modal"><i
                                                class="uil-edit mr-1"></i>Edit Accessories Variant Details</button>
                                                </div>
                                    {/* </div>
                                                            ...
                                                            <div className='row'>
                                                                ...
                                                                <div className="col-md-12">
                                                                    <div className="btn-toolbar sw-toolbar sw-toolbar-top justify-content-right" style={{ float: 'right' }}>
                                                                        ...
                                                                        //     })
                                                                        //   }}
                                                                          onClick={this.Savefootwearvariant.bind(this)}>Update Accessories Variant</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
