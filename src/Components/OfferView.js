...
class  OfferView extends Component {
    ...
    componentDidMount() {
        ...
        var empdetailsobj = localStorage.getItem("OfferDetails");
        var empdetails = JSON.parse(empdetailsobj);
       
    
        this.props.setoffername(empdetails.fld_name)
        this.props.setoffercaption(empdetails.fld_caption)
        this.props.setofferprice(empdetails.fld_pricepercent)
        this.props.setoffermaxprice(empdetails.fld_maximumdiscountprice)
        this.props.setofferminprice(empdetails.fld_minimumdiscountprice)
        this.props.setoffercode(empdetails.fld_code)
        this.props.setofferstartdate(empdetails.fld_startdate)
        this.props.setofferenddate(empdetails.fld_enddate)
        this.props.setoffershowonwebsite(empdetails.fld_showonwebsite)

        new Promise( ( resolve, reject ) => {
            setTimeout( resolve, 1000 );
          } ).then( () => {

            this.props.setofferdescription(empdetails.fld_description)
            this.props.setoffertermsconditions(empdetails.fld_termscondition)
        ...
        this.setState({
            ...
            offerId : empdetails.fld_offerid
          })
    }
                            ...
                            <div className="container-fluid">
                                <div className="row page-title">
                                    <div className="col-md-12">
                                        ...
                                        <h4 class="mb-1 mt-0">View Offer</h4>
                                    </div>
                                </div>
