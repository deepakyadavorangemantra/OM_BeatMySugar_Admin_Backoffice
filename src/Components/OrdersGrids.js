...
import moment from 'moment'
 class OrdersGrids extends Component {
  ...
  <table class="table">
            <thead>
              <tr>
                  <td></td>
                  <td></td>  
                  <td style={{textAlign:'center'}} colspan="4"> <h3 className='d-flex justify-content-center bg-light '> Orders Reports</h3></td>
