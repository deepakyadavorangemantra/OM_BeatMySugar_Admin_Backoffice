                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" className="float-right mt-1">
                                            <ol className="breadcrumb">
                                                ...
                                                <li className="breadcrumb-item"><a href="/footwearitemmasterlist">Footwear List</a></li>
                                                <li className="breadcrumb-item"><a href="/footwearvariantlist">Footwear Variant List</a></li>
                                                <li className="breadcrumb-item active" aria-current="page">Add New Footwear Variant</li>
                                                </ol>
                                        </nav>
                                        <h4 className="mb-1 mt-0">Add New Footwear Variant</h4>
                                    </div>
                                </div>
                                            ...
                                            <div className="card-body">
                                                <div id="smartwizard-arrows">
                                                    <ul>
                                                        ...
                                                        }} className="wizardlist nav-link">Footwear Item Variants</a></li>
                                                        ...
                                                        <li className={this.state.PageTitle == '2' ? 'active nav-item' : this.state.Page2 == 'Done' ? 'done nav-item' : ''}><a onClick={() => {
                                                            ...
                                                            className="wizardlist nav-link">Packaging Weight</a></li>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="toast fade show" role="alert" aria-live="assertive"
                                                                ...
                                                                <div className="toast-header">
                                                                    <strong className="mr-auto">footwear Item Variants</strong>
                                                                </div>
