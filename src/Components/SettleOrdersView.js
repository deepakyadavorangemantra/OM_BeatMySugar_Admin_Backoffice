...
class SettleOrdersView extends React.Component
{
    ...
    var ordermain = JSON.parse(localStorage.getItem('OrderToBeSettleData'))
...
},"GetSplitOrderDetails").then((results1) => 
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">View Order To Settle
                                    </li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">View Order To Settle
                            </h4>
                        </div>
                    </div> 
...
<td>
  ...
  <div class="card">
      ...
      {this.state.VendorOrders.map((ord, index)=>(
       ...
       onClick={this.OnReleasePayment.bind(this)}
    ...
    OnReleasePayment(){
      ...
      for(var i =0 ; i< this.state.SplitDetails.length;i++){
        PostApiCall.postRequest({

          merchantid : this.state.SplitDetails[i].fld_merchantid,
          paymentid : this.state.SplitDetails[i].fld_vendorpaymentid,
          orderid : this.state.MainOrder.fld_orderid,
          settleon : moment().format('lll')
      
      },"AddPaymentRelease").then((results1) => 
      ...
      if(results1.status == 200 || results1.status==201){
        ...
        if(cn == this.state.SplitDetails.length){
          Notiflix.Loading.Remove()
          Notiflix.Notify.Success('Payment Successfully Released')
    
          window.location.href = '/settleorders'
        }
