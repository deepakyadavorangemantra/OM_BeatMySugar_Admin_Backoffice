...
class ViewFootwear extends Component {
    ...
    componentDidMount() {
        ...
        //   console.log(FootwearData)
           ...
           new Promise( ( resolve, reject ) => {
            ...
            this.setState( { 
                Description : FootwearData.fld_description,
                FootwearId:FootwearData.fld_id,
                

            } );
        } );

        this.props.setfootwearitemname(FootwearData.fld_name)
        this.props.setfootweargender(FootwearData.fld_gender)
        this.props.setfootwearitemtype(FootwearData.fld_typeid)
        this.props.setfootwearbrand(FootwearData.fld_brandid)
        this.props.setfootwearcompany(FootwearData.fld_companyid)
        this.props.setfootwearmanufacture(FootwearData.fld_manufacturerid)
        this.props.setfootwearmarketer(FootwearData.fld_marketerid)
        this.props.setfootwearreturnable(FootwearData.fld_returnable)
        this.props.setfootwearreturnabledays(FootwearData.fld_returnabledays)
        this.props.setfootwearhsn(FootwearData.fld_hsncode)
        this.props.setfootweargst(FootwearData.fld_gstpercent)
      

        if(FootwearData.fld_returnable == 'No'){
            this.setState({
                isReturnable : false
            })
                        ...
                        GetApiCall.getRequest("GetCountry").then(resultdes =>
                            resultdes.json().then(obj => {
                                  ...
                                  this.setState({
                                    ...
                                    CountryOfOrigin : FootwearData.fld_countryoforigin == null || FootwearData.fld_countryoforigin == '' ? 'India' : FootwearData.fld_countryoforigin
    ...
    onChangeItem(itemname){
     ...
     Savefootwear(){
                         ...
                         if(this.props.footcredential.HSNCode!=''){
                              if(this.props.footcredential.GstRate!=''){
                       ...
                       //    const objs = JSON.parse(result._bodyText)
                          ...
                          if(results.status == 200 || results.status==201){
                           ...
                           Notiflix.Notify.Success('Footwear successfully updated.')
           ...
           ApproveFootwear(){
            if(this.state.ApproveAccessGranted){
                ...
                confirmAlert({
                    ...
                    message: 'Are you sure you want to approve footwear.',
                    buttons: [
                      {
                        label: 'Yes',
                        onClick: () => {
                ...
                PostApiCall.postRequest({
                    ...
                    if(results.status == 200 || results.status==201){
                        ...
                        Notiflix.Notify.Success('Footwear successfully approved.')
                        window.location.href = '/footwearitemmasterlist'
                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" class="float-right mt-1">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">View Footwear</li>
                                                </ol>
                                        </nav>
                                        <h4 class="mb-1 mt-0">View Footwear Item</h4>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center col-lg-5" style={{float : 'right'}}>
                                      ...
                                      onClick={this.ApproveFootwear.bind(this)}
                                        class="btn btn-primary" id="btn-new-event" data-toggle="modal"><i
                                                class="uil-check mr-1"></i>Approve Footwear </button>
                                                </div>
