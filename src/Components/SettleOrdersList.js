...
class SettleOrdersList extends Component {
    ...
    componentDidMount(){
        Notiflix.Loading.Init({
          ...
          GetApiCall.getRequest("GetSettleOrders").then(resultdes =>
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Orders To Be Settle
                                    </li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">Orders To Be Settle
                            </h4>
                        </div>
                    </div> 
                                ...
                                <td>{(index+1)}.</td>
                                   ...
                                   <td>{data.fld_name}<br />{data.fld_email}<br/>{data.fld_mobile}</td>
                                    ...
                                    onClick={()=>{
                                        ...
                                        localStorage.setItem('OrderToBeSettleData',JSON.stringify(data))
                                        window.location.href = '/viewsettleorder'
                                    }}
                                    >
                                <span  >
                                <Edit3/>
...
export default SettleOrdersList;