...
class BlogView extends Component {
    ...
    componentDidMount() {
        ...
        //   console.log(ArticleData)
          ...
          new Promise( ( resolve, reject ) => {
            ...
            this.props.setShortDescription(ArticleData.fld_shortdescription)
            this.props.setArticalContent(ArticleData.fld_content)
           
          } );


          this.setState({
              imagePreviewUrlCover : ArticleData.fld_coverimage,
              imagePreviewUrl : ArticleData.fld_previewimage,
              Show : ArticleData.fld_showonwebsite,
              ArticleId : ArticleData.fld_id
          })

                    this.props.setCategory(ArticleData.fld_categoryid)
                    this.props.setSubCategory(ArticleData.fld_subcategoryid)
            ...
            for(var i = 0;i<ArticleData.Tags.split(',').length;i++){
                tg.push({value : ArticleData.Tags.split(',')[i].split('#')[0], label : ArticleData.Tags.split(',')[i].split('#')[1]})
            }
    ...
    SavePreviewImage(obj){
        ...
        form.append('filename' , 'Preview-'+this.state.ArticleId);
...
}else
{
    ...
    SaveCoverImage(obj){
        ...
        form.append('foldername' , 'Article')
        form.append('filename' , 'Cover-'+this.state.ArticleId)
            ...
            PostApiCall.postRequest({
               ...
               if(results1.status == 200 || results1.status==201){
                ...
                if(count == this.state.Tags.length){
                    ...
                    Notiflix.Loading.Remove()
                    Notiflix.Notify.Success('Article successfully updated.')
    ...
    handleImageSubmit(){
        if(this.state.imagePreviewUrl != ''){
            if(this.state.imagePreviewUrlCover != ''){
        this.setState({
            PageTitle: '3',
            Page2: 'Done'
        })
                            ...
                            <div className="container-fluid">
                                <div className="row page-title">
                                    <div className="col-md-12">
                                        ...
                                        <h4 className="mb-1 mt-0">View Article</h4>
                                    </div>
                                </div>
                                                                            ...
                                                                            <div className="col-md-6">
                                                                                <div className="form-group">
                                                                                    ...
                                                                                    <select className="form-control custom-select"
                                                                                        ...
                                                                                        onChange={this.handleWrittenByWhomeChange}
                                                                                    >
                                                                                        <option></option>
                                                                ...
                                                                <div className='row'>
                                                                    ...
                                                                    <div className="col-md-12">
                                                                        <div className="btn-toolbar sw-toolbar sw-toolbar-top justify-content-right" style={{ float: 'right' }}>
                                                                            ...
                                                                            >Previous</button>
                                                                            <button className="btn btn-secondary sw-btn-next  btn-radius-left" onClick={this.handleSubmitChange.bind(this)}>Update</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
