...
class SplitPaymentList extends Component {
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Split Payment List
                                    </li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">Split Payment List
                            </h4>
                        </div>
                    </div> 
                                ...
                                <td>{(index+1)}.</td>
                                   ...
                                   <td>{data.fld_name}<br />{data.fld_email}<br/>{data.fld_mobile}</td>
                                    ...
                                    onClick={()=>{
                                        ...
                                        localStorage.setItem('SplitDetails',JSON.stringify(data))
                                        window.location.href = '/view-split-payment'
                                    }}
                                    >
                                <span  >
                                <Edit3/>
