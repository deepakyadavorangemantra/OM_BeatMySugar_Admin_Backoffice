                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Doctor List
                                    </li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">Doctor List
                            </h4>
                        </div>
                    </div> 
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-6 text-right" style={{display : this.state.AddAccess ? '' : 'none'}}>
                                       ...
                                       class="btn btn-primary" id="btn-new-event" data-toggle="modal"><i
                                               class="uil-plus mr-1"></i>Add New Doctor</button>
