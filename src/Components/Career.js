                ...
                GetApiCall.getRequest("GetCountry").then(resultdes =>
                    resultdes.json().then(obj => {
                      ...
                      if(obj.data.length != 0 ){
                        this.props.setcareercountry(obj.data[100].label)
                      ...
                      PostApiCall.postRequest({
                        ...
                        if(results.status == 200 || results.status==201){
                            ...
                            if(objstate.data.length != 0 ){
                                this.props.setcareerstate(objstate.data[0].label)
                                this.setState({
       ...
       PostApiCall.postRequest({
         ...
         showonwebsite :this.state.Status,
          ...
          if(results.status == 200 || results.status==201){
           ...
           Notiflix.Notify.Success('Job opeining successfully added.')
           ...
           Notiflix.Loading.Remove()
           Notiflix.Notify.Failure('Job opeining already registered.')
         } 
       }
          )
        )
                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" class="float-right mt-1">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Add Job Opeining</li>
                                            </ol>
                                        </nav>
                                        <h4 class="mb-1 mt-0">Add Job Opeining</h4>
                                    </div>
                                </div>
