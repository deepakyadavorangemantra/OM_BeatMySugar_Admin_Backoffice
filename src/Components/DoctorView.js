...
class DoctorView extends Component {
    ...
    componentDidMount() {
        ...
        //    console.log(DocData.Specialisation)
          ...
          this.setState({
              ...
              ConsentFile : DocData.fld_consent
                ...
                this.props.setMedicalRegistrationId(DocData.fld_medicalregistrationid)
                this.props.setStartDateOfPractice(DocData.fld_startdateofpractice)
                this.props.setStartDateOfDiabetesPractice(DocData.fld_startdateofdiabitespractice)
                this.props.setOverallExperience(DocData.fld_overallexperience)
                this.props.setDiabetesExperience(DocData.fld_diabetesexperience)
                ...
                var sp = []
                if(DocData.Specialisation != null){
                    for(var i = 0; i < DocData.Specialisation.split(',').length ; i++){
                        

                        sp.push({label : DocData.Specialisation.split(',')[i],value : DocData.Specialisation.split(',')[i]})
                    }
                    this.setState({
                        Specialization : sp
                    })
                ...
                var qua = []
                console.log(DocData.Qualification)
        ...
        GetApiCall.getRequest("GetQualification").then(resultdes =>
            ...
            GetApiCall.getRequest("GetSpecialisation").then(resultdes =>
                resultdes.json().then(objdesignation => {
                  this.setState({
                    SpecializationData: objdesignation.data,
        ...
        PostApiCall.postRequest({
           ...
           var filteredRights = objsub.data;
                ...
                for(var i = 0 ; i< filteredRights.length ;i++){
                    ...
                    if(filteredRights[i].fld_menuname == 'Edit Doctors'){
                    ...
                    }else if(filteredRights[i].fld_menuname == 'Approve Doctors'){
    ...
    handleDoctorProfile = () =>{
        ...
        }else{Notiflix.Notify.Failure('Please upload doctor'+"'"+'s profile photo.')}
    ...
    OnCertificatePdfSubmit(data,obj){
        ...
        {    
                                ...
                                form.append('foldername' , 'DoctorCertificate')
    ...
    UpdateCertificatePdf(cert,data,obj){
        ...
        PostApiCall.postRequest({
            ...
            id : data[i],
            certificate : 'https://images.beatmysugar.com/images/DoctorCertificate/'+cert[i],
            updatedby : details[0].fld_staffid,
            updatedon : moment().format('lll')
            
         
       },"UpdateDoctorPdf").then((results2) => 
    ...
    OnSpecialisationSubmit(obj){
        ...
        for(var i = 0 ;i < this.state.Specialization.length;i++)
         {                        
            PostApiCall.postRequest({
                doctorid : this.state.DoctorId,
                specialisation : this.state.Specialization[i].value,
                updatedby : details[0].fld_staffid,
                updatedon : moment().format('lll'),
                ...
                if(results.status == 200 || results.status==201){
                    ...
                    count = count + 1
                    if(count == this.state.Specialization.length){
    ...
    OnConsentSubmit(obj){
        ...
        form.append('foldername' , 'DoctorConsent')
        ...
        status: image.status
            ...
            PostApiCall.postRequest({
                ...
                consent : 'https://images.beatmysugar.com/images/DoctorConsent/'+res.data.Message.split(',')[2].split('=')[1].trim(),
                updatedby : details[0].fld_staffid,
                updatedon : moment().format('lll')
                
             
           },"UpdateDoctorConsent").then((results1) => 
    ...
    OnPhotosubmit(obj){
        ...
        status: image.status
            ...
            PostApiCall.postRequest({
                ...
                id : this.state.DoctorId,
                photo : 'https://images.beatmysugar.com/images/Doctor/'+res.data.Message.split(',')[2].split('=')[1].trim(),
                updatedby : details[0].fld_staffid,
                updatedon : moment().format('lll')
                
             
           },"UpdateDoctorPhoto").then((results1) => 
             ...
             if(results1.status == 200 || results1.status==201){
                ...
                this.props.setcleardoctor()
                Notiflix.Loading.Remove()
                Notiflix.Notify.Success('Doctor successfully updated.')
...
}else
{
    ...
    handleSubmit = () =>{
        ...
        if(this.state.ConsentFile != null){
                    ...
                    Notiflix.Loading.Dots('');
                        ...
                        PostApiCall.postRequest({
                            id : this.state.DoctorId,
                             ...
                             medicleid : this.props.Doc.MedicalRegistrationId,
                             practicestartdate : this.props.Doc.StartDateOfPractice,
                             diabetesstartdate : this.props.Doc.StartDateOfDiabetesPractice,
                             diabeticexp : this.props.Doc.DiabetesExperience,
                    ...
                    Notiflix.Loading.Remove()
                    Notiflix.Notify.Failure('Doctor with medical registration id already present.')
                  }
            }))
    ...
    ApproveDoctor(){
        if(this.state.ApproveAccessGranted){
            ...
            confirmAlert({
                ...
                message: 'Are you sure you want to approve doctor.',
                buttons: [
                  {
                    label: 'Yes',
                    onClick: () => {
            ...
            PostApiCall.postRequest({
                ...
                if(results.status == 200 || results.status==201){
                    ...
                    Notiflix.Loading.Remove()
                    Notiflix.Notify.Success('Doctor successfully Approved.')
                    window.location.href = '/doctorlist'
                }else
                {
                    Notiflix.Loading.Remove()
                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" class="float-right mt-1">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="#">Doctors List</a></li>
                                               
                                                <li class="breadcrumb-item active" aria-current="page">View Doctor</li>
                                            </ol>
                                        </nav>
                                        <h4 class="mb-1 mt-0">View Doctor</h4>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center col-lg-5" style={{float : 'right'}}>
                                      ...
                                      onClick={this.ApproveDoctor.bind(this)}
                                        class="btn btn-primary" id="btn-new-event" data-toggle="modal"><i
                                                class="uil-check mr-1"></i>Approve Doctor </button>
                                                </div>
                                            ...
                                            <div className="card-body">
                                                <div id="smartwizard-arrows">
                                                    <ul>
                                                        ...
                                                        }} class="wizardlist nav-link">Doctor Profile</a></li>
                                                            ...
                                                            <form className="needs-validation" novalidate onSubmit={(e) => {
                                                                ...
                                                                <div className="toast fade show" role="alert" aria-live="assertive"
                                                                    ...
                                                                    <div class="toast-header">
                                                                        <strong class="mr-auto">Doctor Profile</strong>
                                                                    </div>
                                                                    <div class="toast-body">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                  ...
                                                                                  <div class="col-md-9" style={{marginTop : '26px'}}>
                                                                                   ...
                                                                                   <div class="col-md-6">
                                                                                    ...
                                                                                    {this.state.TitleData.map(title => (
                                                                                       ...
                                                                                       <div class="col-md-9">
                                                                                       <div class="form-group mb-2">
                                                                                       <label for="validationCustom05">Doctor Name<span className="mandatory">*</span></label>
                                                                               ...
                                                                               <div class="col-md-6">
                                                                               <div class="form-group mb-2">
                                                                                   <label for="validationCustom05">Medical Registration Id<span className="mandatory">*</span></label>
                                                                                   <input type="text" class="form-control" id="validationCustom05"
                                                                                   value = {this.props.Doc.MedicalRegistrationId}
                                                                                   disabled={true}
                                                                                   onChange = {this.handleMedicalRegistrationIdChange}
                                                                                  ></input>
                                                                               ...
                                                                               onChange = {this.handleStartDateOfPracticeChange}
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                    <label for="sw-arrows-first-name" >Start Date Of Diabetes Practice</label>
                                                                                    <input type="month" 
                                                                                    max={moment().format('YYYY-MM')}
                                                                                    onKeyDown={(e) => e.preventDefault()} 
                                                                                     class="form-control" id="validationCustom05"
                                                                                     disabled={!this.state.IsVisible}
                                                                                    value = {this.props.Doc.StartDateOfDiabetesPractice}
                                                                                    onChange = {this.handleStartDateOfDiabetesPracticeChange}
                                                                                    ></input>
                                                                                </div>
                                                                                    </div>
                                                                               </div>
                                                                       ...
                                                                       <div class="col-md-6">
                                                                            <div class="form-group mb-3">
                                                                                <label for="validationCustom01">Diabetes Experience (eg : x year x months)</label>
                                                                                <input type="text" class="form-control"  required 
                                                                                value = {this.props.Doc.DiabetesExperience}
                                                                                disabled={true}
                                                                                onChange = {this.handleDiabetesExperienceChange}
                                                                                />
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="row">
                                                                                   <div class="col-md-12">
                                                                                   <div class="form-group mb-2">
                                                                                   <label for="validationCustom05">Specialization (Select one or more specialisation)<span className="mandatory">*</span></label>
                                                                                   
                                                                                  
                                                                                <Select 
                                                                                isDisabled={!this.state.IsVisible}
                                                                                    options={this.state.SpecializationData}
                                                                                        value={this.state.Specialization}
                                                                                        onChange={(sp)=>{
                                                                                            this.setState({Specialization : sp})
                                                                                        }}
                                                                                        isMulti
                                              ...
                                              disabled={!this.state.IsVisible}
                                                    > Add Doctor Qualification</button>
                                                </div>
                                                    ...
                                                    <div className='row'>
                                                        ...
                                                        <div className="col-md-12">
                                                            <div className="btn-toolbar sw-toolbar sw-toolbar-top justify-content-right" style={{ float: 'right' }}>
                                                                ...
                                                                <button 
                                                                 disabled={!this.state.IsVisible}
                                                                className="btn btn-secondary sw-btn-next  btn-radius-left" onClick={this.handleSubmit.bind(this)}>Update</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
