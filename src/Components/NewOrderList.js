...
class NewOrderList extends Component {
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">New Order List
                                    </li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">New Order List
                            </h4>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <td>{(index+1)}.</td>
                                                 <td style={{whiteSpace : 'nowrap'}}>{data.fld_ordernumber}<br/><br/>{data.fld_orderdate}<br/><br/><b>{data.fld_txnid}</b></td>
                                   <td>{data.fld_name}<br />{data.fld_email}<br/>{data.fld_mobile}</td>
                                    ...
                                    onClick={()=>{
                                        ...
                                        localStorage.setItem('OrderDetailsForAssignData',JSON.stringify(data))
