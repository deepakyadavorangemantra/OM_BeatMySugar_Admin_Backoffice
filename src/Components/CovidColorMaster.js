...
class FootwearColorMaster extends Component {
    ...
    componentDidMount(){
        Notiflix.Loading.Init({
          ...
          GetApiCall.getRequest("GetCovidColorList").then(resultdes =>
    ...
    onPost = () =>{
      ...
      var details=JSON.parse(login)
        ...
        },"AddCovidColorMaster").then((resultFootC) =>
        resultFootC.json().then(objBookC => {
            if(resultFootC.status == 200 || resultFootC.status == 201){
                this.props.setclearfootcolor()
            Notiflix.Loading.Remove();
            Notiflix.Notify.Success('Covid & Health Essentials color successfully added.')
            window.location.reload()
            }else
            {
              Notiflix.Loading.Remove();
              Notiflix.Notify.Failure('Covid & Health Essentials color already present.')
            }
        })
        )
    }
     ...
     constructor(props){
        ...
        SaveColor(){
            if(this.props.footcolorcredentails.FootwearColor!=''){
              ...
              Notiflix.Notify.Failure('Please enter covid & health essentials color.')
           }
        }
            ...
            if(this.props.footcolorcredentails.FootwearColor!=''){
              ...
              var details=JSON.parse(login)
                PostApiCall.postRequest ({
                    ...
                    updatedby : details[0].fld_staffid,
                    updatedon : moment().format('lll')
                },"UpdateCovidColorMaster").then((resultFootC) =>
                resultFootC.json().then(objBookC => {
                    if(resultFootC.status == 200 || resultFootC.status == 201){
                        this.props.setclearfootcolor()
                    Notiflix.Loading.Remove();
                    Notiflix.Notify.Success('Covid & Health Essentials color successfully updated.')
                    window.location.reload()
                    }else
                    {
                      Notiflix.Loading.Remove();
    ...
    <div class="modal-content modelcontent2">
      <div class="modal-header">
        <h4 class="modal-title">Add New Covid & Health Essentials Color</h4>
      </div>
    ...
    <div class="modal-content modelcontent2">
      <div class="modal-header">
        <h4 class="modal-title">Update Covid & Health Essentials Color</h4>
      </div>
      <div class="modal-body">
            <div class="col-md-12">
            <div class="form-group mb-3">
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Covid & Health Essentials Color Master</li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">Covid & Health Essentials Color Master</h4>
                        </div>
                    </div> 
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                {this.state.FootwearCData.length == 0 ? 
                                 <tr><td colSpan={4} style={{textAlign:'center'}}>No Covid & Health Essentials Color Available</td></tr> : 
                                 ''}
                                       ...
                                       <script src="assets/libs/datatables/dataTables.bootstrap4.min.js"></script>
                                           ...
                                           onClick={()=>{
                                            confirmAlert({
                                              ...
                                              message: 'Are you sure you want to delete covid & health essentials color.',
                                              buttons: [
                                                {
                                                  label: 'Yes',
                                                  onClick: () => {
                                          ...
                                          PostApiCall.postRequest({
                                            ...
                                            covidcolorid : data.fld_id,
                                           
                                        
                                            },"DeleteCovidColorMaster").then((results) => 
                                              ...
                                              if(results.status == 200 || results.status==201){
                                                  ...
                                                  Notiflix.Loading.Remove()
                                                  Notiflix.Notify.Success('Covid & Health Essentials color successfully deleted.')
                                                  window.location.reload()
                                              }else
                                              {
                                                  Notiflix.Loading.Remove()
