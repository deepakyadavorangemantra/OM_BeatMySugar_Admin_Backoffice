              ...
              <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb" class="float-right mt-1">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Food Products List
                            </li>
                        </ol>
                    </nav>
                    <h4 class="mb-1 mt-0">Food Products List
                    </h4>
                </div>
                    </div> 
                                 ...
                                 <label for="validationCustom01">Filter By:</label>
                                  ...
                                  <select type="text" class="form-control"  required >
                                   ...
                                   <div class="col-md-6 text-right" style={{display : this.state.AddAccess ? '' : 'none'}}>
                                       <a href='/addfooditemmaster'>
                                       <button 
                                       
                                       class="btn btn-primary" id="btn-new-event"><i
                                               class="uil-plus mr-1"></i>Add New Food Item</button>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <tr><td colSpan={7} style={{textAlign:'center'}}>No Food Item Master Available</td></tr> : 
                                ''} 
                                ...
                                <td>{data.fld_code}</td>
                                     <td>{data.fld_name} 
                                      ...
                                      onClick={()=>{
                                        ...
                                        localStorage.setItem('FoodParentIdDetails',JSON.stringify(data))
                                ...
                                >{data.VariantCount} Variant{data.VariantCount == 1 ? '' : 's'} Available ( <span style={{color:'red'}}>{data.NotApproved} Pending</span>, <span style={{color:'green'}}>{data.Approved} Approved</span> )</a>
                                    ...
                                    onClick={()=>{
                                        ...
                                        localStorage.setItem('FoodItemMasterDetails',JSON.stringify(data))
                                        window.location.href = '/viewfooditemmaster'
                                    }}
                                    >
                                <span  >
                                <Edit3/>
