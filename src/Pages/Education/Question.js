...
class EduQuestions extends Component {
                        ...
                        <div className="col-md-12">
                            <nav aria-label="breadcrumb" className="float-right mt-1">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Chapter's Questions</li>
                                </ol>
                            </nav>
                            <h4 className="mb-1 mt-0">Questions Master</h4>
                        </div>
                    </div> 
                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-md-4 text-right">
                                        ...
                                        className="btn btn-primary" id="btn-new-event" data-toggle="modal"><i
                                                className="uil-plus mr-1"></i>Add New Question</button>
                                    </div>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div className="col-12">
                            <div className="card">
                                ...
                                {this.state.TopicsList.length == 0 ? 
                                 <tr><td colSpan={5} style={{textAlign:'center'}}>No Questions Available</td></tr> : 
                                 ''} 
...
const mapStateToProps = state => ({
  ...
  export default connect(mapStateToProps) (EduQuestions);
