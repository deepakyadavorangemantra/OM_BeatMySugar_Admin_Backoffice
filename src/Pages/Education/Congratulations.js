        ...
        saveCongratulation=( CongratulationData)=>{
            Notiflix.Loading.Dots('Please wait...');
                var login=localStorage.getItem('LoginDetail');
                    ...
                    },"AddCongratulation").then((resultcongratulation) =>
                    resultcongratulation.json().then(objArticleSub => {
                        if(resultcongratulation.status == 200 || resultcongratulation.status == 201){
                            // this.props.setClearArticleSubCategory()
                            Notiflix.Loading.Remove();
        ...
        updateCongratulationData=(CongratulationData)=>{
            ...
            var login=localStorage.getItem('LoginDetail');
                ...
                PostApiCall.postRequest ({
                    ...
                    updatedon : moment().format('lll')
                },"UpdateCongratulation").then((resultcongratulation) =>
                resultcongratulation.json().then(objArticleSub => {
                    if(resultcongratulation.status == 200 || resultcongratulation.status == 201){
                        // this.props.setClearArticleSubCategory()
                        Notiflix.Loading.Remove();
                        ...
                        <div className="col-12">
                            <div className="card">
                                ...
                                {this.state.CongratulationsData.length == 0 ? 
                                 <tr><td colSpan={5} style={{textAlign:'center'}}>No congratulations Available this chapter</td></tr> : 
                                 ''} 
                                       ...
                                       <script src="assets/libs/datatables/dataTables.bootstrap4.min.js"></script>
                                           ...
                                           onClick={()=>{
                                            confirmAlert({
                                              ...
                                              message: 'Are you sure you want to delete congratulation.',
                                              buttons: [
                                                {
                                                  label: 'Yes',
                                                  onClick: () => {
